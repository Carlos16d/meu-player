...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 1. Esconder a barra superior
        ActionBar actionBar = getSupportActionBar();
        if (actionBar != null) {
            actionBar.hide();
        }

        // 2. Deixar tela cheia (sem notch, sem icones)
        ...
        // 4. O SEU CÓDIGO HTML AQUI DENTRO
        String html = """
                <!DOCTYPE html>
                <html lang="pt-BR">
                <head>
                ...
                <style>
                  ...
                  @keyframes bater {
                    0% { transform: translate(var(--tx), var(--ty)) translate(-5px, 0); }
                    50% { transform: translate(var(--tx), var(--ty)) translate(5px, 0); }
                    100% { transform: translate(var(--tx), var(--ty)) translate(-5px, 0); }
                  }
        ...
        // Carregar o HTML que está dentro dessa String
