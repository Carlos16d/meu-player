...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAudio.setOnClickListener(v -> { if (exoPlayer != null) debug("🎵 Áudio: use o menu do player"); });
        btnSubtitle.setOnClickListener(v -> { if (exoPlayer != null) debug("📝 Legenda: use o menu do player"); });
    ...
    // ==================== SERVIDOR HTTP (EXATAMENTE COMO ANTES) ====================
    ...
    // ==================== DOWNLOAD (EXATAMENTE COMO ANTES) ====================
    ...
    private void startDownload(String source) {
        ...
        // Monitor de download - thread separada com lock
        new Thread(() -> {
            while (downloading) {
