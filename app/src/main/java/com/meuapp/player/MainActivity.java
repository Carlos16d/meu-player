    ...
    private void watch() {
        ...
        try {
            ...
            mediaPlayer.setOnPreparedListener(mp -> {
                debug("✅ MediaPlayer pronto | " + mp.getDuration()/1000 + "s");
            ...
            mediaPlayer.setOnCompletionListener(mp -> debug("🏁 Fim"));
            
            mediaPlayer.prepareAsync();
            
        } catch (Exception e) {
            debug("❌ Erro MediaPlayer: " + e.getMessage());
        }
    }
